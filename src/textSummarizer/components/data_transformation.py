...
class DataTransformation:
    ...
    def convert_examples_to_features(self, example_batch):
        ...
        return {
            "input_ids": input_encodings["input_ids"],  # ids of the tokens of the input
            "attention_mask": input_encodings[
                "attention_mask"
            ],  # 1 for every existing tokens, padded with 0 for same lengths
            "labels": target_encodings[
                "input_ids"
            ],  # ids of the tokens of the output summary
        }
